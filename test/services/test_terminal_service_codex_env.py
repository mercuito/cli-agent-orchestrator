...
def test_create_terminal_rejects_identity_kwargs_before_persisting(
    tmp_path: Path,
...
def test_create_terminal_identity_codex_runtime_passes_provider_data_dir(
    ...
    with (
        ...
        terminal_service.create_terminal_for_agent_identity(
            identity,
        )
...
def test_create_terminal_context_launch_context_uses_context_provider_data_dir(
    ...
    with (
        ...
        terminal_service.create_terminal_for_agent_identity(
            identity.for_workspace_context("wctx_123")
        )
...
def test_create_terminal_deserializes_provider_runtime_and_passes_resume_args(
    ...
    with (
        ...
        terminal_service.create_terminal_for_agent_identity(identity)
...
def test_create_terminal_clears_stale_resume_state_and_retries_cold_start(
    ...
    with (
        ...
        terminal = terminal_service.create_terminal_for_agent_identity(identity)
...
def test_create_terminal_for_agent_identity_requires_bound_workspace_context(
    implementation_partner_identity_factory,
):
    from cli_agent_orchestrator.services import terminal_service
