...
def test_prepare_identity_claude_runtime_materializes_profile_skills(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
):
    from cli_agent_orchestrator.utils.claude_runtime import prepare_identity_claude_runtime
...
def test_prepare_identity_claude_runtime_requires_claude_login(tmp_path: Path):
    from cli_agent_orchestrator.utils.claude_runtime import prepare_identity_claude_runtime
