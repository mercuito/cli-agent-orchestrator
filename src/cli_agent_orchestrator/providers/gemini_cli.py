...
class GeminiCliProvider(BaseProvider):
    ...
    def _write_policy_deny_rules(self) -> None:
        ...
        excluded = get_disallowed_tools("gemini_cli", allowed_tools)
        if not excluded:
            return
        ...
        lines = [
            ...
            f"# Allowed tools (CAO): {', '.join(allowed_tools)}",
            "",
        ]
    ...
    def _register_mcp_servers(self, mcp_servers: Mapping[str, Any]) -> None:
